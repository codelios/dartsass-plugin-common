...
export class CleanCSSMinifier {
    ...
    public minify(src: Buffer, inputSourceMap: Buffer | null, disableSourceMap: boolean): Promise<MinifyOutput> {
        const self = this;
    ...
    public minifySync(src: Buffer, inputSourceMap: Buffer | null, disableSourceMap: boolean): MinifyOutput {
